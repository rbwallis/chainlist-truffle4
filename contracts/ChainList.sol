...
//Import the file from Ownable.sol
 import "./Ownable.sol";

//inheritance connects Ownable with Chainlist with(is)
...
//address owner; Not needed for this exercise
...
// Event: logging a new buyer
   event LogBuyArticle(
     ...
     //modifier onlyOwner(){ Not needed for this exercise
    ...
    //   _;
     ...
     //function ChainList() public { Not needed for this exercise
    //   owner = msg.sender;
    // }
