...
//event- defining the LogSellArticle event
event LogSellArticle(
  address indexed _seller,
  string _name,
  uint256 _price
    // indexed: used to filter, ex: just show the seller
  );
  ...
  //   sellArticle("Default article", "This is an article set by default", 1000000000000000000);
   ...
   function sellArticle(string _name, string _description, uint256 _price) public {
     ...
     //event -trigger an event by calling it like a function, tell it to run the event
